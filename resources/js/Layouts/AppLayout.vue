<template>
  <div class="h-screen w-screen overflow-hidden bg-bg text-text flex flex-col antialiased">
    <div class="flex-1 flex min-h-0 overflow-hidden">
      <!-- Sidebar -->
      <aside class="w-72 flex-shrink-0 h-full bg-surface border-r border-neutral-800 flex flex-col z-20 select-none">
        <!-- Logo -->
        <div class="h-16 flex items-center px-6 border-b border-neutral-800 shrink-0">
          ...
          >
            <div class="w-9 h-9 rounded-xl bg-accent flex items-center justify-center text-bg shadow-sm shrink-0 group-hover:scale-105 group-hover:bg-accent-400 transition-all">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3.5 space-y-1.5 min-h-0">
          ...
          >
            ...
            <span class="truncate">{{ t('nav.support', 'Destek Ol') }}</span>
        ...
        <div class="p-4 border-t border-neutral-800 text-xs text-neutral-500 space-y-1.5 shrink-0 bg-surface">
          ...
          <div class="flex items-center justify-between">
            <span>{{ t('header.creator', 'Yapımcı') }}</span>
            <a
